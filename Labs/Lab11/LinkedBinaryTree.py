...
def __contains__(self, item):
    '''Return True if val exists in the binary tree
    and false if not'''
    def subtree_contains(item):
        ...
        #recursive case
            ...
            if self.root.data == item: return True
            else:
                return subtree_contains(self.root.left) or subtree_contains(self.root.right)
    return subtree_contains(item)
